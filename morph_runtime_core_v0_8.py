"""
MORPH Runtime Core v0.8
Adaptive Priority + Scheduler Pressure

Adds on top of v0.7:
- SchedulerPressureEngine
- adaptive priority scoring
- horizon pressure map
- queue rebalancing between short / medium / deep
- route confidence in fabric state
- pressure-aware deferred boosting
...
class SchedulerPressureEngine:
    ...
    def rebalance(schedule: MultiScaleSchedule, pressure: Dict[str, float]) -> MultiScaleSchedule:
        # Pressure-aware queue amplification.
...
class FabricOrchestratorV08:
    ...
    def run(self, prompt: str, context_items: List[ContextItem]) -> RuntimeState:
        ...
        state.active_modules = [
            "FabricAssemblyEngine","FabricOrchestratorV08","FabricHealthMonitor","HorizonPlanner","MultiScaleScheduler","SchedulerPressureEngine","DeferredWorkRegistry",
...
def demo() -> None:
    ...
    print("=== MORPH Runtime Core v0.8 Demo / Run 1 ===")
    ...
    print("\n=== MORPH Runtime Core v0.8 Demo / Run 2 ===")
