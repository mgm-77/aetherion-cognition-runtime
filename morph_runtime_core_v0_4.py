"""
MORPH Runtime Core v0.4
Adds Persistent Inference Residue on top of v0.3.

Main additions:
- ResidueBundle
- ResidueRegistry
- residue extraction after each run
- residue retrieval before execution
- residue-aware memory tiling and route support
- demo with repeated runs showing residue carryover
...
def demo() -> None:
    ...
    runtime = MorphRuntimeCoreV04(route_memory=route_memory, residue_registry=residue_registry)

    prompt = "Prove why a structural contradiction route may be stronger than brute-force checking in a mathematics simulator."

    print("=== MORPH Runtime Core v0.4 Demo / Run 1 ===")
    ...
    print("\n=== MORPH Runtime Core v0.4 Demo / Run 2 ===")
    ...
    print(f"Residue bundles snapshot: {json.dumps(result2.residue_bundles_used, indent=2)}")
